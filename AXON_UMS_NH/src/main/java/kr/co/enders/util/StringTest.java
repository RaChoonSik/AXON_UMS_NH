...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println( EncryptUtil.getEncryptedSHA256("@skdisk12"));
		System.out.println( EncryptUtil.getEncryptedSHA256("sict1!"));
		System.out.println( EncryptUtil.getEncryptedSHA256("ADMIN"));
		System.out.println( EncryptUtil.getEncryptedSHA256("enders1!"));
