...
public class RnsServiceServiceImpl implements RnsServiceService {
	...
	public int serviceCopy(RnsServiceVO serviceVO, PropertiesUtil properties) throws Exception {
		...
		// 복사한 서비스 값 설정
		serviceCopy.setTid(serviceVO.getCopyTid());
		...
		searchRnsSecuApprovalLineVO.setUilang(serviceVO.getUilang());
		
		List<RnsSecuApprovalLineVO> apprLineList = rnsServiceDAO.getRnsApprovalLineList(searchRnsSecuApprovalLineVO);
	...
	public List<RnsSecuApprovalLineVO> getRnsApprovalLineList(RnsSecuApprovalLineVO rnsApprovalLineVO) throws Exception {
		return rnsServiceDAO.getRnsApprovalLineList(rnsApprovalLineVO);
	}
	...
	@Override
	public int insertApiSendTsEmail(RnsRecipientInfoVO apiRnsRecipientInfoVO) throws Exception {
		int result = 0;
