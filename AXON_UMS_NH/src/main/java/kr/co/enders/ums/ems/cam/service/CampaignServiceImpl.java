...
//				}
	...
	public int copyMailInfo(TaskVO taskVO, PropertiesUtil properties) throws Exception {
		...
		//결재함 등록  
		List<SecuApprovalLineVO> apprLineList = campaignDAO.getApprovalLineList(taskVO);
	...
	@Override
	public List<UserVO> getUserListOrg(UserVO userVO) throws Exception {
		return campaignDAO.getUserListOrg(userVO);
	}
