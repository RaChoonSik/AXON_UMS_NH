...
public class RnsAnalysisDAO implements RnsAnalysisMapper {
	...
	public List<RnsAnaMonthVO> getMonthList(RnsAnaMonthVO rnsAnaMonthVO) throws Exception {
		return sqlSessionEms.getMapper(RnsAnalysisMapper.class).getMonthList(rnsAnaMonthVO);
	}

	@Override
	public List<RnsAnaServiceVO> getServiceList(RnsAnaServiceVO rnsAnaServiceVO) throws Exception {
		return sqlSessionEms.getMapper(RnsAnalysisMapper.class).getServiceList(rnsAnaServiceVO);
	}

	@Override
	public List<RnsAnaDomainVO> getDomainList(RnsAnaDomainVO rnsAnaDomainVO) throws Exception {
		return sqlSessionEms.getMapper(RnsAnalysisMapper.class).getDomainList(rnsAnaDomainVO);
	}

	@Override
	public List<RnsAnaDetailLogVO> getReceiverList(RnsAnaDetailLogVO rnsAnaDetailLogVO) throws Exception {
		return sqlSessionEms.getMapper(RnsAnalysisMapper.class).getReceiverList(rnsAnaDetailLogVO);
	}

	@Override
	public List<RnsAnaDetailLogVO> getMailList(RnsAnaDetailLogVO rnsAnaDetailLogVO) throws Exception {
		return sqlSessionEms.getMapper(RnsAnalysisMapper.class).getMailList(rnsAnaDetailLogVO);
	}

	@Override
	public List<RnsAnaDetailLogVO> getDetailLogList(RnsAnaDetailLogVO rnsAnaDetailLogVO) throws Exception {
		return sqlSessionEms.getMapper(RnsAnalysisMapper.class).getDetailLogList(rnsAnaDetailLogVO);
	}
	

	@Override
	public List<RnsAnaMailSendResultVO> getMailSendResultList(RnsAnaMailSendResultVO rnsAnaMailSendResultVO) throws Exception {
		return sqlSessionEms.getMapper(RnsAnalysisMapper.class).getMailSendResultList(rnsAnaMailSendResultVO);
	}	
	
	@Override
	public List<CodeVO> getServiceCodeList() throws Exception {
		return sqlSessionEms.getMapper(RnsAnalysisMapper.class).getServiceCodeList();
	}
	
	@Override
	public List<String> getSenderList() throws Exception {
		return sqlSessionEms.getMapper(RnsAnalysisMapper.class).getSenderList();
	}

	@Override
	public List<CodeVO> getRcodeList(CodeVO codeVO) throws Exception {
		return sqlSessionEms.getMapper(RnsAnalysisMapper.class).getRcodeList(codeVO);
	}
