...
function goLogin() {
	...
	var aa = CryptoJS.AES.encrypt("happyjune", "!SI#CTEMS");
	var bb = CryptoJS.AES.encrypt("june11", "!SI#CTEMS");
	var cc = CryptoJS.AES.encrypt("june12", "!SI#CTEMS");
	var dd = CryptoJS.AES.encrypt("june13", "!SI#CTEMS");
			...
			<form id="loginForm" name="loginForm" action="<c:url value='/lgn/lgn.ums'/>" method="post">
				<fieldset>
					...
					<section class="login-inner">
						<h1 class="ttl">AXON EMS SYSTEM</h1>
						...
						<div class="form-box">				
							...
							<div style="text-align : center;">
							    <img src="<c:url value='/img/common/nh_logo.gif'/>" alt="NH농협손해보험" title="NH농협손해보험">
							</div> 
						</div>	
					</section>
