...
<script type="text/javascript" src="<c:url value='/js/rns/tmp/rnsTempListP.js'/>"></script>
								...
								<div class="graybox">
									...
									<div class="list-area">
										<ul>
											...
											<li><label>템플릿명</label>
												<div class="list-item">
													<input type="text" id="searchTempNm" name="searchTempNm" value="<c:out value='${searchVO.searchTempNm}'/>" placeholder="템플릿명을 입력해주세요."> <input type="hidden" id="searchChannel" name="searchChannel" value="<c:out value='${searchVO.searchChannel}'/>">
												</div></li>
