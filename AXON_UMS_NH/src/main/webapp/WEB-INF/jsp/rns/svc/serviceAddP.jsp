				...
				<div id="content" class="single-style">
					...
					<section class="cont-body">
						...
						<form id="serviceInfoForm" name="serviceInfoForm" method="post">
							...
							<input type="hidden" id="sname"name="sname" value="<c:out value='${userInfo.mailFromNm}'/>">
									...
									<div class="list-area">
										<ul>
											<li class="col-full">
												...
												<div class="list-item">
													<input type="text" id="tnm" name="tnm" placeholder="캠페인명읗 입력해주세요.">
												</div>
											</li>
                                            <li class="col-full"> 
                                                <label>EAI CAMP 번호</label>
                                                <div class="list-item">
                                                    <div class="filebox">
                                                        <input type="text" id="eaiCampNo" name="eaiCampNo" style="width:calc(100% - 10.4rem);" placeholder="캠페인 번호를 입력해주세요.(숫자)" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
                                                        <button type="button" class="btn fullblue" id="chkEaiCampNo"  onclick="eaiCampNoCheck();" val="N">중복확인 검사</button>
                                                    </div>
                                                </div>
                                            </li>
											<li>
