				...
				<div id="content" class="single-style">
					...
					<section class="cont-body">
						...
						<form id="serviceInfoForm" name="serviceInfoForm" method="post">
							...
							<input type="hidden" id="sname"name="sname" value="<c:out value='${serviceInfo.sname}'/>">
									...
									<div class="list-area">
										<ul>
                                            ...
                                            <li>
                                                <label>옵션</label>
                                                <div class="list-item">
                                                    <label><input type="checkbox" name="recvChkYn" id="recvChkYn" <c:if test="${'Y' eq serviceInfo.recvChkYn}"> checked </c:if> value="${ campTempInfo.recvChkYn }"><span>수신확인</span></label>
                                                </div>
                                            </li>
                                            <li class="col-full">
                                                <label class="required">캠페인 번호</label>
                                                <div class="list-item">
                                                    <div class="filebox">
                                                        <p class="label bg-gray" style="width:100%"><c:out value="${serviceInfo.tid}"/></p>
                                                    </div>
                                                </div>
                                            </li>                                            
											<li class="col-full">
												...
												<div class="list-item">
													<input type="text" id="tnm" name="tnm" value="<c:out value='${serviceInfo.tnm}'/>" placeholder="캠페인명을 입력해주세요.">
												</div>
											</li>
										</ul>
									</div>
