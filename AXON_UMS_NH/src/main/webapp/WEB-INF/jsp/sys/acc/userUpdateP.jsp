												...
												<li>
													...
													<c:choose>
														<c:when test="${'Y' eq userInfo.ipaddrchkYn}">
															<label><input type="checkbox" id="ipaddrchkYn" name= "ipaddrchkYn" value="Y" onclick="setUserIp();" checked="checked"><span>IP 주소 체크</span></label>
															<input type="text" id="ipaddrTxt" name="ipaddrTxt" value="<c:out value="${userInfo.ipaddrTxt}" />" style="width: 42%;">
														</c:when>
														<c:otherwise>
														<label><input type="checkbox" id="ipaddrchkYn" name= "ipaddrchkYn" value="N" onclick="setUserIp();"><span>IP 주소 체크</span></label>
															<input type="text" id="ipaddrTxt" name="ipaddrTxt" placeholder="0.0.0.0" disabled="disabled"  style="width: 42%;">
