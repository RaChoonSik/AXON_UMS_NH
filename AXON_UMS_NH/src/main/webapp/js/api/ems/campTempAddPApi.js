...
*	작성자 : 김준희
*	작성일시 : 2024.03.05
*	설명 : API 대량메일 캠페인템플릿 신규등록 JavaScript
**********************************************************/
...
function goAdd () { 
	...
	$("#campTempInfoForm").attr("target","iFrmMail").attr("action","/api/ems/campTempAddApi.ums").submit();
}
...
function checkProhibit(){
	...
	$.ajax({
		type: "POST",
		url: '/com/checkCampTempProhibitWord.ums',
		data: frmData,
		processData: false,
		contentType: false,
